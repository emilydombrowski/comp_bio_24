...
This is the link to [Homework #11](hw11.html), which uses the BaracudaR practices to do batch processing in R. This homework is presented in an Rmarkdown for viewing, but the code is not evaluated because of folder and file placement (this code had to be executed in a separate project and folder structure to incorperate the BaracudaR functions).
